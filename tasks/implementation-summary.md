...
### Slice 6 — Local agent skill-awareness (B2)
Not implemented. Requires: `HKASK_SKILLS_DIR` env var for path resolution, SKILL.md frontmatter parsing in the swarm server, system prompt augmentation in `agent_executor.rs`. This is a larger cross-crate change.
